...
describe('Data Utilities', () => {
	...
	describe('imagePath', () => {
		it('should generate correct path with default variant', () => {
			...
			expect(result).toBe('https://imagedelivery.net/3Z234PNqO8eVcjKwgURmyQ/test-image/public');
		});

		it('should generate correct path with custom variant', () => {
			const result = imagePath('test-image', 'mx960');
			expect(result).toBe('https://imagedelivery.net/3Z234PNqO8eVcjKwgURmyQ/test-image/mx960');
		});

		it('should handle special characters in id', () => {
			const result = imagePath('test/image-with-special_chars');
			expect(result).toBe('https://imagedelivery.net/3Z234PNqO8eVcjKwgURmyQ/test/image-with-special_chars/public');
		});
	});
