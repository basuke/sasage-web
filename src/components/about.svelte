...
<article class="px-3 sm:px-0 max-w-xl mx-auto text-justify lg:max-w-2xl lg:text-lg">
    ...
    {:else if lang === 'ja'}
        <section>
            <p class="mb-6">
                サンフランシスコ・ベイエリアを拠点に活動するイラストレーターのササゲマユミです。東京造形大学でテキスタイルデザインを専攻しました。卒業後は東京で13年間、多くのブランドのシューズデザイナーとして働いていましたが、2013年にサンフランシスコに移住。
                2020年よりフリーのイラストレーターとして活動しています。
            </p>
            <p class="mb-6">
                人物画を中心に食べ物や植物のイラストを得意とし、アナログとデジタルをミックスさせて独自の世界観を作っています。イラストレーションを見た人がその先の物語を想像できる様なイラストを目指しています。タッチはカラフルなストーリー性のあるイラスト、和モダン、白黒の線画など。データ納品。
            </p>
            <p class="mb-6">
