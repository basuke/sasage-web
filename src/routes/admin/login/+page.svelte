    ...
    <div class="max-w-sm w-full bg-white rounded-lg shadow-md p-8">
        ...
        <form onsubmit={handleLogin}>
            ...
            <input
                ...
                required
                disabled={loading}
                class="w-full px-3 py-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50"
